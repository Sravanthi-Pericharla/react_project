...
const AllocatorNotifications: React.FC = () => {
  ...
  const typeIcon: Record<string, string> = {
    ...
    leave: 'bi-clipboard-check text-info',
  ...
  return (
    <DashboardLayout>
      <div className="page-header">
        ...
        <p className="page-subtitle">Stay informed about availability changes and system events</p>
      </div>
          ...
          notifications.map(n => (
            <div key={n.id} className={`notif-item ${!n.read ? 'unread' : ''}`}
              ...
              <div className="d-flex align-items-start gap-3">
                <i className={`bi ${typeIcon[n.type] || 'bi-bell text-secondary'} mt-1`}></i>
...
export default AllocatorNotifications;
